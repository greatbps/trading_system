...
def register_holdings_to_db():
    ...
    holdings_to_register = [
        ...
        {'symbol': '005360', 'name': '모나미', 'strategy': 'BREAKOUT'},
        {'symbol': '023160', 'name': '현대위아', 'strategy': 'MOMENTUM'},
        {'symbol': '226950', 'name': '올릭스', 'strategy': 'VWAP_STRATEGY'},
        {'symbol': '059090', 'name': 'KCC', 'strategy': 'RSI_STRATEGY'},
        {'symbol': '011070', 'name': 'LG이노텍', 'strategy': 'SUPERTREND_EMA'},  # HTS명 사용
        {'symbol': '223250', 'name': '영창케미칼', 'strategy': 'SMART_MONEY'}  # HTS명 사용
    ]
